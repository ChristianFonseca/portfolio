...
export default function ChatPage() {
  ...
  const getResponse = (query: string): string => {
    ...
    if (lowerQuery.includes("experience") || lowerQuery.includes("work")) {
      return "Christian has 9+ years of experience as a Senior Data & AI Engineer. He's worked at companies like JobLeap AI, TIVIT LATAM, BBVA, BCP, and Rimac. He specializes in building scalable data architectures, ML pipelines, and production-ready AI solutions."
    }

    if (lowerQuery.includes("skill") || lowerQuery.includes("technology")) {
      return "Christian is proficient in Machine Learning, Deep Learning, NLP, LLMs, Python, PySpark, SQL, AWS, Azure, Databricks, TensorFlow, PyTorch, and more. He has extensive experience with cloud platforms and MLOps practices."
    }
    ...
    if (lowerQuery.includes("education") || lowerQuery.includes("degree")) {
      return "Christian is currently pursuing a Master's in Data Science and a Master's in Artificial Intelligence at Universidad Nacional de Ingeniería, Peru. He also holds a Bachelor's in Mechatronics Engineering and completed a Diploma in Advanced Computing in India."
    }
    ...
    if (lowerQuery.includes("teaching") || lowerQuery.includes("professor")) {
      return "Christian is also a Professor at Data Mining Consulting (DMC) and BPC Business School. He's taught over 20 advanced analytics programs covering Data Engineering, MLOps, Deep Learning, and more, training 100+ professionals."
    }
  ...
  return (
    <main className="min-h-screen relative dark flex flex-col animate-page-fade">
      ...
      <div className="flex-1 pt-32 pb-8 px-6 flex flex-col max-w-4xl mx-auto w-full">
        <h1 className="text-4xl md:text-5xl font-bold mb-8 text-center bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent floating-element">
