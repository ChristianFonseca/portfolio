...
// Campo de una sola imagen: preview + subir (con recorte si hay aspect) + selector
// de imágenes ya subidas. El valor guardado es la ruta (/uploads/x.webp).
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1 space-y-2">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <UploadButton aspect={aspect} onUploaded={onChange} />
      ...
      {pickerOpen && (
        <div className="mt-3 rounded-xl border border-border bg-card/60 p-3">
          {assets === null ? (
            ...
            <p className="py-4 text-center text-xs text-muted-foreground">Aún no hay imágenes subidas.</p>
          ) : (
